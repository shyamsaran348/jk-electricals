...
const Clients = () => {
 ...
 <span className="text-lg font-semibold text-muted hover:text-gold transition-colors">Hatsun Agro Products Ltd</span>
 <span className="text-lg font-semibold text-muted hover:text-gold transition-colors">Aston Shoes Pvt Ltd</span>
 <span className="text-lg font-semibold text-muted hover:text-gold transition-colors">EMAS Engineering & Contractors Pvt Ltd</span>
 <span className="text-lg font-semibold text-muted hover:text-gold transition-colors">PSL Holdings Ltd</span>
 <span className="text-lg font-semibold text-muted hover:text-gold transition-colors">IGP Engineers Ltd</span>
 <span className="text-lg font-semibold text-muted hover:text-gold transition-colors">Parag Milk Foods Pvt Ltd</span>
 <span className="text-lg font-semibold text-muted hover:text-gold transition-colors">Creamline Dairy Pvt Ltd</span>
 <span className="text-lg font-semibold text-muted hover:text-gold transition-colors">Farida Shoes Pvt Ltd</span>
 <span className="text-lg font-semibold text-muted hover:text-gold transition-colors">Delta Shoes Pvt Ltd</span>
 <span className="text-lg font-semibold text-muted hover:text-gold transition-colors">Indian Coast Guards</span>
 </div>
 </div>
 ...
 <div>
 <span className="block text-lg font-bold text-forest">Al Kuhaimi Metal Industries</span>
 <span className="text-sm font-semibold uppercase tracking-widest text-muted">Dammam, KSA</span>
 </div>
 <div>
 <span className="block text-lg font-bold text-forest">Al Khaleej Holding & Co</span>
