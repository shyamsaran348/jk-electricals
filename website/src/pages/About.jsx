...
const About = () => {
 ...
 <Helmet>
 <title>About Us | JK Industrial Impex</title>
 <meta name="description" content="Pioneering precision engineering and industrial materials supply since 2007." />
 </Helmet>
 ...
 <span className="text-xs font-bold uppercase tracking-[0.2em] text-gold mb-4 block">Company Profile</span>
 <h2 className="text-h2 font-bold text-forest mb-8 leading-tight">Setting the Gold Standard in Industrial Infrastructure</h2>
 ...
 <div className="text-h2 font-black text-gold mb-1"><CountUp end={16} suffix="+" /></div>
 <div className="text-[10px] font-bold text-muted uppercase tracking-widest mt-2">Years Exp</div>
 </div>
 <div className="bg-white p-6 border border-border shadow-sm rounded-xl">
 <div className="text-h2 font-black text-gold mb-1"><CountUp end={1} suffix="Cr+" /></div>
 <div className="text-[10px] font-bold text-muted uppercase tracking-widest mt-2">Annual Turnover</div>
 </div>
 <div className="bg-white p-6 border border-border shadow-sm rounded-xl">
 <div className="text-h2 font-black text-gold mb-1"><CountUp end={10} suffix="+" /></div>
 ...
 <div className="absolute -inset-4 bg-forest/5 scale-95 group-hover:scale-100 transition-transform duration-500"></div>
 <img 
 ...
 <h2 className="text-h2 font-bold text-forest">Decades of Excellence</h2>
 </div>
 ...
 <h3 className="text-h3 font-bold text-forest mb-4">{item.year}</h3>
 <p className="text-lg text-muted leading-relaxed">{item.desc}</p>
 </div>
 <div className="absolute left-1/2 transform -translate-x-1/2 w-6 h-6 bg-forest border-4 border-white shadow-xl z-10"></div>
 ...
 <span className="text-xs font-bold uppercase tracking-[0.2em] text-gold mb-8 block border-l-4 border-gold pl-4">From the Founder's Desk</span>
 <h2 className="text-h2 font-black text-forest mb-10 leading-tight tracking-tight">"Precision is not just a measurement; it is a promise of reliability."</h2>
 ...
 <div className="w-16 h-16 bg-gold/10 rounded-full flex items-center justify-center text-gold font-black text-xl">JS</div>
 <div>
 <p className="text-2xl font-black text-forest mb-1">Julian K. Sterling</p>
 <p className="text-xs font-bold text-gold uppercase tracking-widest">Founder & Executive Chairman</p>
 </div>
 </div>
 </motion.div>
 </div>
