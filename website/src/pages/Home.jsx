...
const Home = () => {
  ...
  return (
    <div className="w-full">
      ...
      <section className="relative h-[80vh] min-h-[700px] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto w-full">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} className="max-w-3xl">
            <h1 className="text-display font-black text-navy mb-4 leading-tight tracking-tight">
            ...
            <div className="bg-white p-2 flex items-center mb-8 max-w-2xl shadow-xl rounded-full">
              <input 
                ...
                className="bg-transparent border-none text-navy placeholder-gray-400 w-full px-6 py-3 focus:outline-none focus:ring-0 font-medium"
              />
              <button className="bg-blue hover:bg-navy transition-colors text-white px-8 py-3 rounded-full font-bold uppercase tracking-wider text-sm whitespace-nowrap duration-300">
                Search
              </button>
            </div>

            <div className="flex flex-col sm:flex-row gap-4">
              <Link to="/products" className="bg-blue text-white px-8 py-4 rounded-full text-sm text-center uppercase tracking-widest font-bold hover:bg-navy transition-colors duration-300 shadow-lg">
                Explore Catalog
              </Link>
              <Link to="/contact" className="bg-white border border-border text-navy px-8 py-4 rounded-full text-sm text-center uppercase tracking-widest font-bold hover:border-navy hover:shadow-md transition-all duration-300 shadow-sm">
                Bulk Enquiry
              </Link>
            </div>
          </motion.div>
            ...
            <div className="flex w-max animate-marquee group-hover:[animation-play-state:paused] opacity-60 hover:opacity-100 transition-opacity duration-500">
              ...
              {[...Array(2)].map((_, i) => (
                <div key={i} className="flex items-center justify-around gap-16 px-8 min-w-max">
                  <span className="font-display text-2xl font-bold tracking-tighter hover:text-blue transition-colors cursor-pointer">Schneider</span>
                  <span className="font-display text-2xl font-bold tracking-tighter hover:text-blue transition-colors cursor-pointer">SIEMENS</span>
                  <span className="font-display text-2xl font-bold tracking-tighter hover:text-blue transition-colors cursor-pointer">ABB</span>
                  <span className="font-display text-2xl font-bold tracking-tighter hover:text-blue transition-colors cursor-pointer">Polycab</span>
                  <span className="font-display text-2xl font-bold tracking-tighter hover:text-blue transition-colors cursor-pointer">Fuji Electric</span>
                  <span className="font-display text-2xl font-bold tracking-tighter hover:text-blue transition-colors cursor-pointer">Rexnord</span>
                  <span className="font-display text-2xl font-bold tracking-tighter hover:text-blue transition-colors cursor-pointer">Hilcool</span>
                  <span className="font-display text-2xl font-bold tracking-tighter hover:text-blue transition-colors cursor-pointer">Omron</span>
                  <span className="font-display text-2xl font-bold tracking-tighter hover:text-blue transition-colors cursor-pointer">Spectrum</span>
                  <span className="font-display text-2xl font-bold tracking-tighter hover:text-blue transition-colors cursor-pointer">BN</span>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="text-center mb-16 max-w-2xl mx-auto">
            <span className="text-xs font-bold text-blue tracking-widest uppercase">Comprehensive Inventory</span>
            <h2 className="text-h2 font-bold text-navy mt-4 leading-tight">Shop By Category</h2>
          </motion.div>
              ...
              <motion.div key={idx} initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={idx} className="group relative overflow-hidden h-72 border border-border bg-white shadow-sm block">
                <Link to={`/products?category=${cat.slug}`} className="block w-full h-full relative p-6">
                  ...
                  <div className="relative z-10 h-full flex flex-col justify-between">
                    <h3 className="text-xl font-black text-navy uppercase tracking-wide max-w-[70%]">{cat.title}</h3>
                    <div className="w-10 h-10 bg-white border border-border shadow-sm flex items-center justify-center text-blue transform translate-x-[-10px] opacity-0 group-hover:translate-x-0 group-hover:opacity-100 transition-all duration-300 rounded-full">
                      <ArrowRight size={18} />
                    </div>
                  </div>
                </Link>
      ...
      <section className="py-24 bg-surface text-navy relative overflow-hidden">
        <div className="container mx-auto relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="space-y-8">
              <span className="text-xs font-bold text-blue tracking-widest uppercase border-l-4 border-blue pl-4">The Distributor Advantage</span>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 pt-4">
                <div className="bg-white p-6 border border-border shadow-sm rounded-xl">
                  <div className="w-12 h-12 bg-blue/10 rounded-full flex items-center justify-center mb-4"><PackageCheck className="text-blue" size={24} /></div>
                ...
                <div className="bg-white p-6 border border-border shadow-sm rounded-xl">
                  <div className="w-12 h-12 bg-blue/10 rounded-full flex items-center justify-center mb-4"><ShieldCheck className="text-blue" size={24} /></div>
                ...
                <div className="bg-white p-6 border border-border shadow-sm rounded-xl">
                  <div className="w-12 h-12 bg-blue/10 rounded-full flex items-center justify-center mb-4"><Truck className="text-blue" size={24} /></div>
                ...
                <div className="bg-white p-6 border border-border shadow-sm rounded-xl">
                  <div className="w-12 h-12 bg-blue/10 rounded-full flex items-center justify-center mb-4"><Zap className="text-blue" size={24} /></div>
      ...
      <section className="py-24 bg-surface">
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
            <div>
              <span className="text-xs font-bold text-blue tracking-widest uppercase border-l-4 border-blue pl-4">Proven Track Record</span>
              <h2 className="text-h2 font-black text-navy mt-2 tracking-tight">Major Project Supplies</h2>
            </div>
            <Link to="/clients" className="text-sm font-bold uppercase tracking-widest text-blue hover:text-navy transition-colors flex items-center gap-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 border border-border shadow-sm rounded-xl hover:shadow-md transition-shadow group">
              ...
              <h4 className="text-xl font-bold text-navy mb-2 line-clamp-2">Dairy Plant Electrification for Hatsun Agro</h4>
            ...
            <div className="bg-white p-8 border border-border shadow-sm rounded-xl hover:shadow-md transition-shadow group">
              ...
              <h4 className="text-xl font-bold text-navy mb-2 line-clamp-2">Maritime Supply for Indian Coast Guards</h4>
            ...
            <div className="bg-white p-8 border border-border shadow-sm rounded-xl hover:shadow-md transition-shadow group">
              ...
              <h4 className="text-xl font-bold text-navy mb-2 line-clamp-2">Facility Setup for Aston Shoes</h4>
      ...
      <section className="py-24 bg-white text-center">
        <div className="container mx-auto max-w-5xl">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="bg-surface rounded-3xl p-12 md:p-20 border border-border shadow-sm relative overflow-hidden">
            <div className="absolute top-0 right-0 w-64 h-64 bg-blue/5 rounded-full blur-3xl transform translate-x-1/2 -translate-y-1/2 pointer-events-none"></div>
            <div className="absolute bottom-0 left-0 w-64 h-64 bg-blue/5 rounded-full blur-3xl transform -translate-x-1/2 translate-y-1/2 pointer-events-none"></div>
            
            <div className="relative z-10">
              <h2 className="text-h1 font-black mb-6 leading-tight text-navy">Need Bulk Electrical Supplies?</h2>
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-6">
                <Link to="/contact" className="bg-blue text-white px-12 py-5 text-xs font-bold uppercase tracking-[0.2em] hover:bg-navy transition-all shadow-xl rounded-full">
                  Request a Quote
                </Link>
