      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row items-center gap-16">
          ...
          <div className="w-full md:w-1/2">
            <motion.span initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} className="text-xs font-bold uppercase tracking-[0.2em] text-blue mb-4 block">Case Studies</motion.span>
            <motion.h2 initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} className="text-display font-bold text-navy mb-12 leading-tight">Enterprise Project Highlights</motion.h2>
            ...
            <div className="space-y-16">
              {[
                ...
                >
                  ...
                  <div>
                    <h4 className="text-xl font-bold text-navy mb-4">{project.title}</h4>
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeIn} className="w-full md:w-1/2 relative mt-16 md:mt-0">
            ...
            <div className="absolute top-0 left-0 w-full h-full bg-navy -z-0 translate-x-0 translate-y-0 opacity-10"></div>
          </motion.div>
