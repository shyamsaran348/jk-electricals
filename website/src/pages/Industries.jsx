...
const Industries = () => {
 ...
 <Helmet>
 <title>Industries We Serve | JK Industrial Impex</title>
 <meta name="description" content="Providing high-end electrical distribution for Heavy Machinery, Automation, Infrastructure, and more." />
 </Helmet>

 {/* Hero Section */}
 <section className="relative pt-40 pb-24 bg-surface flex items-center overflow-hidden border-b border-border">
 <div className="absolute top-0 left-0 w-96 h-96 bg-gold/5 rounded-full blur-3xl transform -translate-x-1/2 -translate-y-1/2 pointer-events-none"></div>
 <div className="container mx-auto relative z-10">
 <div className="max-w-2xl">
 <motion.span initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} className="text-xs font-bold uppercase tracking-widest text-gold block mb-4">
 Market Sectors
 </motion.span>
 <motion.h1 initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} className="text-display font-black text-forest mb-6 tracking-tight">
 ...
 <h3 className="text-h3 font-black tracking-tight text-forest mb-4">{industry.name}</h3>
 ...
 <li className="flex items-start gap-3 text-sm font-bold text-forest">
 ...
 <motion.span initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} className="text-xs font-bold uppercase tracking-widest text-gold block mb-4">Core Competency</motion.span>
 <motion.h2 initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={fadeUp} className="text-display font-black text-forest mb-12 leading-tight tracking-tight">Expertise in Action</motion.h2>
 ...
 <div className="bg-gold/10 p-4 h-fit rounded-2xl">
 <div className="w-8 h-8 bg-gold rounded-full"></div>
 </div>
 <div>
 <h4 className="text-xl font-black text-forest mb-2">{item.title}</h4>
 ...
 <h2 className="text-h2 font-black tracking-tight text-forest mb-6 relative z-10">Ready to Optimize Your Industrial Supply Chain?</h2>
 ...
 <button className="bg-forest text-white px-10 py-5 font-bold text-xs uppercase tracking-widest hover:bg-gold transition-colors rounded-full shadow-md">
 Download Sector Brochure
 </button>
 <button className="bg-surface border border-border text-forest px-10 py-5 font-bold text-xs uppercase tracking-widest hover:border-forest transition-colors rounded-full shadow-sm">
 Talk to an Expert
 </button>
 </div>
 </div>
